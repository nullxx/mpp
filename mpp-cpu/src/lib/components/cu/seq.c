...
static int truth_table[TRUTH_TABLE_ROWS][TRUTH_TABLE_COLS] = {
    ...
    {S1, 0, 0, 0, 0, 0, 1, 1, X, X, 1, X, X, X, X, X, X, 0, 1, 0, 1, 0, 1, S21},
    {S1, 0, 0, 0, 0, 0, 1, 0, 1, 1, 1, X, X, X, X, X, X, 0, 1, 0, 0, 0, 0, S16},
    {S1, 0, 0, 0, 0, 0, 1, 1, X, X, 0, 0, 0, 0, 0, X, X, 0, 0, 1, 1, 1, 0, S14},
    {S1, 0, 0, 0, 0, 0, 1, 1, X, X, 0, 0, 0, 0, 1, X, X, 0, 1, 0, 1, 1, 1, S23},
    {S1, 0, 0, 0, 0, 0, 1, 1, X, X, 0, 0, 0, 1, 0, X, X, 0, 1, 1, 0, 0, 0, S24},
    ...
    {S12, 0, 0, 1, 1, 0, 0, X, X, X, 0, 0, 0, X, X, X, X, 0, 0, 0, 0, 1, 1, S3},
    ...
    {S17, 0, 1, 0, 0, 0, 1, X, X, X, X, X, 0, 1, 0, 1, X, 0, 1, 0, 1, 0, 0, S20},
    {S17, 0, 1, 0, 0, 0, 1, X, X, X, X, X, 0, 1, 1, X, 1, 0, 1, 0, 1, 0, 0, S20},
    {S17, 0, 1, 0, 0, 0, 1, X, X, X, X, X, 1, X, X, X, X, 0, 1, 0, 1, 0, 0, S20},
...
void run_cu_seq(void) {
    ...
    for (int i = 0; i < TRUTH_TABLE_ROWS; i++) {
        if (truth_table[i][1] != -1 && truth_table[i][1] != q5) continue;
        if (truth_table[i][2] != -1 && truth_table[i][2] != q4) continue;
        if (truth_table[i][3] != -1 && truth_table[i][3] != q3) continue;
        if (truth_table[i][4] != -1 && truth_table[i][4] != q2) continue;
        if (truth_table[i][5] != -1 && truth_table[i][5] != q1) continue;
        if (truth_table[i][6] != -1 && truth_table[i][6] != q0) continue;
        if (truth_table[i][7] != -1 && truth_table[i][7] != c7) continue;
        if (truth_table[i][8] != -1 && truth_table[i][8] != c6) continue;
        if (truth_table[i][9] != -1 && truth_table[i][9] != c5) continue;
        if (truth_table[i][10] != -1 && truth_table[i][10] != c4) continue;
        if (truth_table[i][11] != -1 && truth_table[i][11] != c3) continue;
        if (truth_table[i][12] != -1 && truth_table[i][12] != c2) continue;
        if (truth_table[i][13] != -1 && truth_table[i][13] != c1) continue;
        if (truth_table[i][14] != -1 && truth_table[i][14] != c0) continue;
        if (truth_table[i][15] != -1 && truth_table[i][15] != fz) continue;
