...
<Code
  ...
  previewVideoSrc="/assets/video/preview/MOV_0F_RB.mp4"
  client:load
/>
...
<Code
  ...
  testCodeText="Probar código"
  previewText="Vista previa"
  previewVideoSrc="/assets/video/preview/MOV_RB_RC.mp4"
  client:load
/>
...
<Code
  ...
  testCodeText="Probar código"
  previewText="Vista previa"
  previewVideoSrc="/assets/video/preview/MOV_RB_AC.mp4"
  client:load
/>
...
<Code
  ...
  testCodeText="Probar código"
  previewText="Vista previa"
  previewVideoSrc="/assets/video/preview/MOV_0F_AC.mp4"
  client:load
/>
